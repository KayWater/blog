    ...
    methods: {
        ...
        publish() {
            ...
            vm.$refs['postForm'].validate((valid) => {
                ...
                PostAPI.updatePost( vm.postForm )
                    .then( (response) => {
                        let data = response.data;
        ...
        loadPost(postID) {
            ...
            UserAPI.getPost(postID)
                .then((response) => {
                    ...
                    vm.postForm.postID = post.id;
                    vm.postForm.title = post.title;
                    vm.postForm.tags = post.tags;
                    vm.postForm.content = post.content;
                    vm.editor.setData(post.content);
