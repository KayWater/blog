...
export default {
    ...
    methods: {
        ...
        loadDraft(draftID) {
            let vm = this;
            UserAPI.getDraft(draftID)
                .then((response) => {
                    let draft = response.data.draft;
                    vm.postForm.draftID = draft.id;
                    vm.postForm.postID = draft.post_id;
                    vm.postForm.title = draft.title;
                    vm.postForm.tags = draft.tags;
                    vm.postForm.content = draft.content;
                    vm.editor.setData(draft.content);
