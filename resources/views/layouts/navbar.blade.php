<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="{{ url('') }}">PIBlog</a>
    ...
    <!--         </li> -->
          ...
          <form class="form-inline my-2 my-lg-0" id="searchForm" method="get" action="{{url('article/search')}}">
            <input class="form-control mr-sm-2" type="search" id="search"
             name="search" placeholder="Search" aria-label="Search">
            <button class="btn btn-outline-secondary my-2 my-sm-0" id="save" type="submit">Search</button>
          </form>
